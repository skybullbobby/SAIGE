...
option_list <- list(
  make_option("--plinkFile", type="character",default="input/nfam_100_nindep_0_step1_includeMoreRareVariants_poly",
    help="path to plink file for creating the genetic relationship matrix (GRM)"),
  make_option("--phenoFile", type="character", default="input/pheno_1000samples.txt_withdosages_withBothTraitTypes.txt",
    help="path to the phenotype file. The file can be either tab or space delimited"),
  make_option("--phenoCol", type="character", default="y_binary",
  ...
  make_option("--covarColList", type="character", default="x1,x2",
  ...
  make_option("--outputPrefix", type="character", default="output/example_binary",
    help="path and prefix to the output files [default='output/example_binary']"),
  make_option("--outputPrefix_varRatio", type="character", default="output/example_binary_ratio",
    help="path and prefix to the output the variance ratio file [default=example_binary_ratio]. if NULL, it will be the same as the outputPrefix"),
